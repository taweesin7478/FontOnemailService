                      ...
                      <v-layout class="ma-0" wrap>
                        <v-flex lg12 xs12 >
                          <v-card-title class="pa-0 pb-1 pr-1">
                            ...
                            <v-toolbar-title >Onemail System Status</v-toolbar-title>
                            </v-col>
                          </v-card-title>
                        </v-flex>
                        <v-flex lg12>
                          ...
                          >
                              ...
                              <v-flex lg12 xs12>
                                <p style="white-space:pre-wrap;" v-html="item.note"></p>
                              </v-flex>
                              <v-flex lg12 xs12>
                                <p style="white-space:pre-wrap;" v-html="item.alert"></p>
                              </v-flex>
                              <v-flex lg12 xs12>
                                <p style="white-space:pre-wrap;" v-html="item.detail"></p>
                              </v-flex>
                          </v-card>
                        </v-flex>
                        <!--<v-flex lg4>
                          ...
                          >
                            <v-flex lg12 xs12>
                              <v-toolbar-title >ข้อมูลเพิ่มเติม</v-toolbar-title>
                            </v-flex>
                            <v-flex lg12 xs12 >
                              <v-col cols="12" sm="12" md="12" v-for="item in service" :key="item">
                                <v-row>
                                <p style="white-space:pre-wrap; font-size: 12px;">{{item.service}}</p>
                                <v-spacer></v-spacer>
                                <p :style="ColorStyle(item.status)">{{item.status}}</p>
                                </v-row>
                              </v-col>
                            </v-flex>
                          </v-card>
